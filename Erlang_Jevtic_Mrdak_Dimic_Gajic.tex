...
Takođe je interesantno videti da neka okruženja imaju integrisani mejl server koji nudi funkcije za primanje i slanje e-pošte i ostale mogućnosti, olakšavajući rad korisnicima. Naprimer slanje e-pošte izgleda ovako: \\
...
Na operativnim sistemima zasnovanim na {\em Windows}, Erlang možemo instalirati preuzimanjem binarne datoteke sa oficijalnog sajta programskog jezika \cite{sajt}. Dupli klik na {\em .exe} fajl i onda je potrebno ispratiti uputstva. \\
