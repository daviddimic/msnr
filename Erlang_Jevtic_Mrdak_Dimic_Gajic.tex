...
prvi predstavio. Na planu konkurentnosti Erlang svojevrstan primer (detaljnije u poglavlju \ref{sec:osobine}). \\ 
...
inicijalni skup mogućnosti i namena. 
...
U tom istom trenutku, mi smo sposobni da takav svet pojmimo i odreagujemo na sve što se dešava oko nas. Dakle, mi prirodno razumemo konkurentnost.
...
Sva izračunavanja se obavljaju u okviru procesa.
